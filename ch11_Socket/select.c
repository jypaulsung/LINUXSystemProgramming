...
int TcpSockfd;   // TCP socket file descriptor
int UdpSockfd;   // UDP socket file descriptor
int UcoSockfd;   // UNIX-domain stream socket file descriptor
int UclSockfd;   // UNIX-domain datagram socket file descriptor
